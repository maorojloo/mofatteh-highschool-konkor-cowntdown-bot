...
def report():
    ...
    my_message = "دیوس خر برو درستو بخون کونت پارس این همه روز دیگخ کونی برو درس بخون کونم تو هیپوتالاموست!!!!!!!!!!!!!کونیییییییییییییییییییییییییییییییییی!".format(result)
